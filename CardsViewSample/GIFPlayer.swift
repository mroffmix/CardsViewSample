...
class GIFPlayerView: UIView {
    ...
    convenience init(gifName: String) {
        ...
        if gifName.isValidURL {
            gif = UIImage.gif(url: gifName) ?? UIImage()
        } else {
            gif = UIImage.gif(asset: gifName) ?? UIImage()
        }
...
//    func updateView(gifName: String) {
...
struct GIFView: UIViewRepresentable {
    ...
    func updateUIView(_ uiView: GIFPlayerView, context: UIViewRepresentableContext<GIFView>) {
      //  uiView.updateView(gifName: gifName)
    }
